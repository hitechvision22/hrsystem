            ...
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>employee/Disciplinary" class="text-white"><i class="" aria-hidden="true"></i>Liste disciplinaire</a></button>
                    </div>
                </div>
               <div class="row">
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-user-o" aria-hidden="true"></i>ajouter nouveau employee <span class="pull-right " ></span></h4>
                            </div>
                                ...
                                <form class="row" method="post" action="Save" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <select name="deg" class="form-control custom-select" required>
                                            <option>Sélectionner Designation</option>
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <select name="blood" class="form-control custom-select">
                                            <option>Select Groupe Sanguin</option>
