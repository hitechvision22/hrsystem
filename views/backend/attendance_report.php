	...
	<div class="container-fluid">
		...
		<div class="row m-b-10">
			<div class="col-12">
				...
				<button type="button" class="btn btn-info"><a href="<?php echo base_url(); ?>attendance/Attendance_Report" class="text-white"><i class="" aria-hidden="true"></i>Rapport de présence</a></button>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Rapport de présence</h4>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body EmployeeInfo">
						...
						Travaillé<span class="hours"></span>Heures en<span class="days"></span>Jours
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Fréquentation complète</h4>
