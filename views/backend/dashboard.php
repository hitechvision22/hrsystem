						...
						<div class="d-flex flex-row">
							...
							<div class="m-l-10 align-self-center">
								<h3 class="m-b-0">
									...
									?> Employees</h3>
								<a href="<?php echo base_url(); ?>employee/Employees" class="text-muted m-b-0">Voir les détails</a>
							</div>
						</div>
					</div>
				</div>
								...
								<tbody>
									<?php foreach ($notice as $value) : ?>
										<tr class="scrollbar" style="vertical-align:top">
											...
											<td>
												<?php
												// Afficher toute la description avec les retours à la ligne
											...
											<td>
												<?php
												echo isset($value->first_name) && isset($value->last_name) ?
