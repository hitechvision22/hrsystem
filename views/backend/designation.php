...
<?php $this->load->view('backend/sidebar'); ?> 
    ...
    <div class="row">
            ...
            <?php if (isset($editdesignation)) { ?>
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Editer Designation</h4>
                    </div>
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Nom Designation</label>
                ...
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">AJouter Designation</h4>
                    </div>
        ...
        <div class="col-7">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Liste des désignations</h4>
                </div>
