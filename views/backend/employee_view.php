			...
			<div class="col-lg-12 col-xlg-12 col-md-12">
				<div class="card">
					...
					<ul class="nav nav-tabs profile-tab" role="tablist">
						<li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab" style="font-size: 14px;">Informations personnelles</a> </li>
						...
						<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#bank" role="tab" style="font-size: 14px;">Compte en banque</a> </li>
						...
						<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#leave" role="tab" style="font-size: 14px;">Partir</a> </li>
						<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#social" role="tab" style="font-size: 14px;"> Social Media</a> </li>
						<?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>
							<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#password" role="tab" style="font-size: 14px;">Changer le mot de passe</a> </li>
						<?php } else { ?>
							<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#password1" role="tab" style="font-size: 14px;">Changer le mot de passe</a> </li>
						<?php } ?>
					</ul>
					<!-- Tab panes -->
					...
					<div class="tab-content">
										...
										<div class="col-md-4">
											<div class="card">
												...
												<div class="card-body"> <small class="text-muted">Email address</small>
													<h6><?php echo $basic->em_email; ?></h6> <small class="text-muted p-t-30 db">Téléphone</small>
						...
						<div class="tab-pane" id="profile" role="tabpanel">
							<div class="card">
								<div class="card-body">
									<h3 class="card-title">Coordonnées permanentes</h3>
									...
									<div class="">
										<h3 class="col-md-12">Présentez les coordonnées</h3>
									</div>
									<hr>
							...
							<div class="card">
								<div class="card-body">
									<form class="row" action="Add_bank_info" method="post" enctype="multipart/form-data">
										<div class="form-group col-md-6 m-t-5">
											<label>Nom du titulaire de la banque</label>
						...
						<div class="tab-pane" id="document" role="tabpanel">
							...
							<div class="card-body">
								<form class="row" action="Add_File" method="post" enctype="multipart/form-data">
									<div class="form-group col-md-6 m-t-5">
										<label class="">Titre du fichier</label>
									...
									<?php } else { ?>
										<div class="form-group">
											<div class="col-sm-12">
												...
												<button type="submit" class="btn btn-success">Ajouter fichier</button>
											</div>
										</div>
									<?php } ?>
								</form>
									...
									<div class="card">
										<div class="card-body">
											...
											<form action="Assign_leave" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label class="">Année</label> <select name="year" class="select2 form-control custom-select" style="width: 100%" id="" required>
														<option value="">Select Here...</option>
														<?php
														for ($x = 2016; $x < 3000; $x++) {
						...
						<div class="tab-pane" id="salary" role="tabpanel">
							<div class="card">
								<div class="card-body">
									<h3 class="card-title">Salaire de base</h3>
									<form action="Add_Salary" method="post" enctype="multipart/form-data">
										<div class="row">
											<div class="form-group col-md-6 m-t-5">
												<label class="control-label">Type de salaire</label>
										...
										<div class="row">
											...
											<div class="form-group col-md-6 m-t-5">
												<label>Loyer de la maison</label>
										...
										<div class="row">
											...
											<div class="form-group col-md-6 m-t-5">
												<label>Caisse de prévoyance</label>
										...
										<?php } else { ?>
											<div class="form-group">
												<div class="col-sm-12">
													...
													<?php } ?>
													<button <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> disabled <?php } ?> type="submit" style="float: right" class="btn btn-success">Ajouter un salaire</button>
												</div>
											<?php } ?>
											</div>
									</form>
