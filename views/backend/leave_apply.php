			...
			<div class="modal-dialog" role="document">
				<div class="modal-content ">
					<div class="modal-header">
						<h4 class="modal-title" id="exampleModalLabel1">Demande d’autorisation</h4>
						...
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<div class="span pull-right">
									<button class="btn btn-info fetchLeaveTotal">Récupérer le congé total</button>
								</div>
								<br>
							</div>
							<div class="form-group">
							...
							<div class="form-group" id="hourAmount">
								...
								<select id="hourAmountVal" class=" form-control custom-select" tabindex="1" name="hourAmount" required>
									...
									<option value="4">Quatre heures</option>
									<option value="5">Cinq heures</option>
									<option value="6">Six heures</option>
									<option value="7">Sept heures</option>
									<option value="8">Huit heures</option>
								</select>
							</div>
							<div class="form-group">
